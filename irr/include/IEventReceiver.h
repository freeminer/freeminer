...
//! Enumeration for "user" events (i.e. ones generated by Luanti itself)
enum EUSER_EVENT_TYPE
{
	/** In-game actions
	 * This event can be used to fire in-game actions without user interactions.
	 * UserData1: The GameKeyType of the button.
	 * UserData2: Whether the button is pressed down.
	 */
	EUET_GAME_KEY = 1
};
