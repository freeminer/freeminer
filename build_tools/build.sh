...
if [ "$DIST" = "Debian" ] || [ "$DIST" = "Ubuntu" ]; then
    ...
    sudo pacman --needed --noconfirm -S git subversion cmake ninja ccache bzip2 zstd libjpeg-turbo freetype2 libxxf86vm libxi sqlite3 hiredis libvorbis openal curl luajit leveldb snappy gettext msgpack-cxx boost  clang lld llvm libc++ libc++abi libpng12 libpng libunwind
    echo Todo
fi
