...
void compressZlib(const u8 *data, size_t data_size, std::ostream &os, int level = 2, bool raw = false);
inline void compressZlib(std::string_view data, std::ostream &os, int level = 2, bool raw = false)
{
