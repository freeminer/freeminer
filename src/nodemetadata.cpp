...
std::vector<v3pos_t> NodeMetadataList::getAllKeys() const
{
...
NodeMetadata *NodeMetadataList::get(v3pos_t p) const
{
...
std::unique_ptr<NodeMetadata> NodeMetadataList::remove(v3pos_t p)
{
...
std::unique_ptr<NodeMetadata> NodeMetadataList::set(v3pos_t p, NodeMetadata *d)
{
	auto ret = remove(p);
	m_data[p] = d;
	return ret;
