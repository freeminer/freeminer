...
void TestMapSettingsManager::testMapSettingsManager()
{
	...
	UASSERT(params->chunksize == v3bpos_t(5));
...
#define GET(x) EmergeManager::getContainingChunk(x, csize)
	...
	UASSERTEQ(auto, GET(v3bpos_t(-2, -2, -2)), v3bpos_t(-2, -2, -2));
	UASSERTEQ(auto, GET(v3bpos_t(0, 0, 0)), v3bpos_t(-2, -2, -2));
	UASSERTEQ(auto, GET(v3bpos_t(1, 1, 1)), v3bpos_t(-2, -2, -2));
	UASSERTEQ(auto, GET(v3bpos_t(2, 2, 2)), v3bpos_t(-2, -2, -2));
	UASSERTEQ(auto, GET(v3bpos_t(2, 3, 2)), v3bpos_t(-2, 3, -2));
	UASSERTEQ(auto, GET(v3bpos_t(0, -3, 0)), v3bpos_t(-2, -7, -2));

	csize = v3bpos_t(5, 2, 5);
	UASSERTEQ(auto, GET(v3bpos_t(0, 0, 0)), v3bpos_t(-2, -1, -2));
	UASSERTEQ(auto, GET(v3bpos_t(0, 1, 0)), v3bpos_t(-2, 1, -2));
	UASSERTEQ(auto, GET(v3bpos_t(3, 3, 3)), v3bpos_t(3, 3, 3));

	csize = v3bpos_t(1);
	UASSERTEQ(auto, GET(v3bpos_t(1, 2, 3)), v3bpos_t(1, 2, 3));
	UASSERTEQ(auto, GET(v3bpos_t(-3, -2, -1)), v3bpos_t(-3, -2, -1));
