...
public:
	...
	*/
	 ...
	 */
	static void add_x(const v3s32 &extent, u32 &i, pos_t a)
	{
		(void)extent;
		i += a;
	}
	 ...
	 */
	static void add_y(const v3s32 &extent, u32 &i, pos_t a)
	{
		i += a * extent.X;
	}
	 ...
	 */
	static void add_z(const v3s32 &extent, u32 &i, pos_t a)
	{
	 ...
	 */
	static void add_p(const v3s32 &extent, u32 &i, v3pos_t a)
	{
...
public:
	...
	*/
	...
	MapNode getNodeNoExNoEmerge(const v3pos_t &p) const
	{
	...
	const MapNode & getNodeRefUnsafeCheckFlags(const v3pos_t &p) const
	{
	...
	void setNode(const v3pos_t &p, const MapNode &n)
	{
		VoxelArea voxel_area(p);
		addArea(voxel_area);
