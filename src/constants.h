...
#define PEER_WS_MAX 0x3fff-1 // MAX_UDP_PEERS
...
constexpr auto FARMESH_STEP_MAX {22};
#elif USE_POS32
#define MAX_MAP_GENERATION_LIMIT (2147483008L)
#define MAX_MAP_GENERATION_LIMITF MAX_MAP_GENERATION_LIMIT
constexpr auto FARMESH_STEP_MAX {22}; // 23 okay for full earth
#else
...
constexpr auto FARMESH_LIMIT {(1 << FARMESH_STEP_MAX)*4};
