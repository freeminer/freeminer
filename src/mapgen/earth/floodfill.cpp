...
public:
    ...
    static std::vector<std::pair<int,int>> flood_fill_area(
...
private:
    ...
    static std::vector<std::pair<int,int>> optimized_flood_fill(
        const std::vector<std::pair<int,int>>& polygon_coords,
    ...
    static std::vector<std::pair<int,int>> original_flood_fill(
        const std::vector<std::pair<int,int>>& polygon_coords,
        int min_x, int max_x, int min_y, int max_y,
        const std::chrono::milliseconds* timeout
    ) {
