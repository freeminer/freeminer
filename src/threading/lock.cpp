...
recursive_lock<GUARD, MUTEX>::recursive_lock(MUTEX &mtx,
		std::atomic<std::size_t> &thread_id_, bool try_lock) : thread_id(thread_id_)
{
...
template <class mutex, class unique_lock, class shared_lock>
std::unique_ptr<unique_lock> locker<mutex, unique_lock, shared_lock>::lock_unique() const
{
	return std::make_unique<unique_lock>(mtx);
}

template <class mutex, class unique_lock, class shared_lock>
std::unique_ptr<unique_lock>
locker<mutex, unique_lock, shared_lock>::try_lock_unique() const
{
...
template <class mutex, class unique_lock, class shared_lock>
std::unique_ptr<shared_lock>
locker<mutex, unique_lock, shared_lock>::try_lock_shared() const
{
...
template <class mutex, class unique_lock, class shared_lock>
std::unique_ptr<recursive_lock<unique_lock, mutex>>
locker<mutex, unique_lock, shared_lock>::lock_unique_rec() const
{
...
template <class mutex, class unique_lock, class shared_lock>
std::unique_ptr<recursive_lock<unique_lock, mutex>>
locker<mutex, unique_lock, shared_lock>::try_lock_unique_rec() const
{
...
template <class mutex, class unique_lock, class shared_lock>
std::unique_ptr<recursive_lock<shared_lock, mutex>>
locker<mutex, unique_lock, shared_lock>::lock_shared_rec() const
{
...
template <class mutex, class unique_lock, class shared_lock>
std::unique_ptr<recursive_lock<shared_lock, mutex>>
locker<mutex, unique_lock, shared_lock>::try_lock_shared_rec() const
{
...
template class locker<try_shared_mutex, std::unique_lock<try_shared_mutex>,
		std::shared_lock<try_shared_mutex>>;
#endif
