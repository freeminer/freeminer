...
fake_function() {
	...
	gettext("Actions and Keybindings");
	...
	gettext("Tinted sunlight");
	gettext("Tint sunlight during sunrise/sunset.");
	gettext("Liquid reflections");
	gettext("When enabled, crude liquid reflections are simulated.\nWave height, length and speed will affect these reflections.");
	...
	gettext("Volumetric Depth Attenuation");
	gettext("Make volumetrics weaker against closer objects to emulate physical volumetrics.");
	gettext("Other Effects");
	gettext("Tinted fog");
	gettext("Makes the color of light fog more saturated.");
	gettext("Translucent foliage");
	gettext("Simulate translucency when looking at foliage in the sunlight.\nIt is recommended to use this with setting \"leaves_style\" set to \"fancy\".");
	gettext("Audio");
	gettext("Volume");
