...
- Freeminer specific files named "fm_*" or src/mapgen/mapgen_earth* or located in src/mapgen/earth src/network/ws src/network/ws_sctp src/network/enet src/network/multi
