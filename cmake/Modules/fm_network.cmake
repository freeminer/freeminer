...
if(USE_MULTI)
    option(ENABLE_ENET "Enable enet networking" 1)
    option(ENABLE_SCTP "Enable SCTP networking (EXPERIMENTAL)" 1)
    if(NOT ANDROID)
        option(ENABLE_WEBSOCKET "Enable Websocket server" 1)
    endif()
endif()
...
elseif(ENABLE_SCTP OR ENABLE_WEBSOCKET_SCTP)
    message(WARNING "SCTP transports disabled: source missing at ${SCTP_SOURCE_DIR}: git clone --recursive --depth 1 https://github.com/sctplab/usrsctp src/external/usrsctp")
endif()
...
if(ENABLE_WEBSOCKET OR (ENABLE_WEBSOCKET_SCTP AND FM_HAVE_SCTP_SOURCE))
    if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/external/websocketpp/websocketpp/config/asio.hpp")
        ...
        if(TARGET Boost::headers)
            ...
            message(WARNING "Websocket disabled because boost not found")
        endif()
    else()
        message(WARNING "Websocket disabled because sources missing: git clone --recursive --depth 1 https://github.com/zaphoyd/websocketpp src/external/websocketpp")
    endif()
endif()
